...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,515 | 🐛 105 | 📅 2026-09-02
精选无人驾驶资源列表，修改自[takeitallsource/awesome-autonomous-vehicles](https://github.com/takeitallsource/awesome-autonomous-vehicles) ⭐ 2,391 | 🐛 1 | 📅 2024-03-15 :fire:.
...
* [GitHub: Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,244 | 🐛 29 | 🌐 Python | 📅 2026-09-02 :star:38.8K - `机器学习`框架、库和软件的`精选列表`。 由Joseph Misiti.Joseph Misiti维护
* [GitHub: Deep Learning Papers Reading Roadmap](https://github.com/songrotek/Deep-Learning-Papers-Reading-Roadmap) ⭐ 39,555 | 🐛 91 | 🌐 Python | 📅 2022-11-27 :star:22.2K - `深度学习论文阅读路线图`从大纲到细节构建，从最新到最先进，从通用到特定领域，重点关注从深度学习开始的SOTA技术。 由Flood Sung维护。
...
* [GitHub: Awesome Robotics](https://github.com/Kiloreux/awesome-robotics) ⭐ 7,004 | 🐛 40 | 📅 2024-09-22 :star:1.19K - 由kiloreux维护的机器人技术的各种书籍，课程和其他资源的列表。

### 计算机视觉|Computer Vision

* [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,538 | 🐛 92 | 📅 2024-05-17 :star: 9.7K (4年前更新)- 计算机视觉资源精选清单
* [Awesome Deep Vision](https://github.com/kjw0612/awesome-deep-vision) ⭐ 11,188 | 🐛 47 | 📅 2023-08-15 :star:7.9K(2年前更新) - 计算机视觉深度学习资源的精选清单
...
* [nuScenes](https://www.nuscenes.org/) - 安波福于2019年3月公开了其数据集，并在[GitHub](https://github.com/nutonomy/nuscenes-devkit) ⭐ 2,799 | 🐛 32 | 🌐 Python | 📅 2026-08-06公开教程。数据集拥有从波士顿和新加坡收集的1000个“场景”的信息，包含每个城市环境中都有的最复杂的一些驾驶场景。该数据集由140万张图像、39万次激光雷达扫描和140万个3D人工注释边界框组成，是迄今为止公布的最大的多模态3D AV数据集。
...
* `PointNet`[charlesq34/pointnet](https://github.com/charlesq34/pointnet) ⭐ 5,462 | 🐛 186 | 🌐 Python | 📅 2023-11-30-
...
* `VoxelNet`[charlesq34/pointnet](https://github.com/charlesq34/pointnet) ⭐ 5,462 | 🐛 186 | 🌐 Python | 📅 2023-11-30 -
  `SOTA（Object Localization & 3D Object Detection）`:Cars、Cyclists、Pedestrian\
  研究机构 : 苹果公司\
  论文 : [VoxelNet: End-to-End Learning for Point Cloud Based 3D Object Detection](https://arxiv.org/abs/1711.06396)
* `SimpleDet`[tusimple/simpledet](https://github.com/tusimple/simpledet) ⭐ 3,085 | 🐛 44 | 🌐 Python | 📅 2021-09-23 - `SOTA on consumer grade hardware at large scale`\
  研究机构 : 图森\
...
* `PointRCNN`[sshaoshuai/PointRCNN](https://github.com/sshaoshuai/PointRCNN) ⭐ 1,817 | 🐛 144 | 🌐 Python | 📅 2022-09-01 -
...
* [kujason/avod](https://github.com/kujason/avod) ⭐ 958 | 🐛 37 | 🌐 Python | 📅 2026-02-05 -`KITTI 3D Object Detection for cars`#2 Cars-Hard(AP:66.38%)\
...
* `SqueezeDet`[BichenWuUCB/squeezeDet](https://github.com/BichenWuUCB/squeezeDet) ⭐ 741 | 🐛 83 | 🌐 Python | 📅 2022-11-22 -`SOTA for KITTI(2016)`\
...
* `PSPNet`[tensorflow/models](https://github.com/tensorflow/models/tree/master/research/deeplab) ⭐ 77,659 | 🐛 1,273 | 🌐 Python | 📅 2026-09-02和[hszhao/PSPNet](https://github.com/hszhao/PSPNet) ⭐ 1,662 | 🐛 78 | 🌐 C++ | 📅 2022-04-15 - `SOTA in (Semantic Segmentation & Real-Time Semantic Segmentation)`，[more detail](https://paperswithcode.com/paper/pyramid-scene-parsing-network),`CVPR 2017`\
  研究机构 : 香港中文大学、商汤\
  论文 : [Pyramid Scene Parsing Network](https://arxiv.org/abs/1612.01105)
* `BiSeNet`[ycszen/TorchSeg](https://github.com/ycszen/TorchSeg) ⭐ 1,410 | 🐛 41 | 🌐 Python | 📅 2020-03-11 -
...
* [bermanmaxim/LovaszSoftmax](https://github.com/bermanmaxim/LovaszSoftmax) ⭐ 1,410 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2024-04-12 - Cityscapes:#1 for `Real-Time（76.9 fps）`、#16 for Mean IoU(63.06%),`CVPR 2018`\
  研究机构 : 鲁汶大学\
...
* [MSiam/TFSegmentation](https://github.com/MSiam/TFSegmentation) ⭐ 592 | 🐛 22 | 🌐 Python | 📅 2022-11-22 -
...
* `LEDNet`[xiaoyufenfei/LEDNet](https://github.com/xiaoyufenfei/LEDNet) ⭐ 522 | 🐛 12 | 🌐 Python | 📅 2020-12-05 - 暂未released，Semantic Segmentation: `Real-time(71FPS)`、Semantic Segmentation(Mean IoU 70.6%)，ICIP 2019\
  研究机构 : 南京邮电大学、天普大学\
  论文 : [LEDNet: A Lightweight Encoder-Decoder Network for Real-Time Semantic Segmentation](https://arxiv.org/abs/1905.02423)，
* `swiftnet`[orsic/swiftnet](https://github.com/orsic/swiftnet) ⭐ 255 | 🐛 21 | 🌐 Python | 📅 2023-10-03 -
...
* [YangZhang4065/AdaptationSeg](https://github.com/YangZhang4065/AdaptationSeg) ⭐ 128 | 🐛 15 | 🌐 Python | 📅 2020-12-16 - SOTA for `Image-to-Image Translation` on SYNTHIA-to-Cityscapes\
  研究机构 :  IEEE Member\
  论文 : [A Curriculum Domain Adaptation Approach to the Semantic Segmentation of Urban Scenes](https://arxiv.org/abs/1812.09953)

### 传感器融合|Sensor Fusion

* [HKUST-Aerial-Robotics/VINS-Mono](https://github.com/HKUST-Aerial-Robotics/VINS-Mono) ⭐ 6,016 | 🐛 293 | 🌐 C++ | 📅 2024-08-14 - SOTA，IROS 2018,IMU和（单目）摄像头融合的校正方法，用来校准IMU和相机之间的时间偏移。\
...
* \[非官方][marsauto/europilot](https://github.com/marsauto/europilot) ⭐ 1,511 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2020-10-25和\[非官方][SullyChen/Autopilot-TensorFlow](https://github.com/SullyChen/Autopilot-TensorFlow) ⭐ 1,276 | 🐛 19 | 🌐 Python | 📅 2024-06-16\
  研究机构 : 英伟达\
  论文 : [End to End Learning for Self-Driving Cars](https://arxiv.org/abs/1604.07316)
* [xinleipan/VirtualtoReal-RL](https://github.com/xinleipan/VirtualtoReal-RL) ⭐ 48 | 🐛 2 | 🌐 C++ | 📅 2018-11-28 -在虚拟环境通过强化学习来训练无人驾驶\
  研究机构 : Berkley、清华大学、上海交通大学\
  论文 : [Virtual to Real Reinforcement Learning for Autonomous Driving](https://arxiv.org/abs/1704.03952)

### 运动规划|Motion Planer

* \[非官方][Iftimie/ChauffeurNet](https://github.com/Iftimie/ChauffeurNet) ⭐ 133 | 🐛 6 | 🌐 Python | 📅 2020-03-09 -  Waymo出品，通过模仿学习对无人车进行运动规划，全文中文翻译:[知乎|每周一篇 & 无人驾驶](https://zhuanlan.zhihu.com/p/57275593)\
  研究机构 : Waymo Research\
...
* [百度 Apollo|开源](https://github.com/ApolloAuto/apollo) ⭐ 26,820 | 🐛 1,046 | 🌐 C++ | 📅 2026-04-16 - 帮助汽车行业及自动驾驶领域的合作伙伴结合车辆和硬件系统，快速搭建一套属于自己的自动驾驶系统。
* [微软 Airsim|开源](https://github.com/Microsoft/AirSim) ⭐ 18,435 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - 作为人工智能研究的平台，以实验自动驾驶汽车的深度学习，计算机视觉和强化学习算法。
* [英特尔Carla|开源](https://github.com/carla-simulator/carla) ⭐ 14,355 | 🐛 1,193 | 🌐 C++ | 📅 2026-09-03  - 用于城市自动驾驶系统的开发、训练和验证的开源模拟器，支持多种传感模式和环境条件的灵活配置
* [优达 self-driving car|开源](https://github.com/udacity/self-driving-car) ⚠️ Archived -用于纳米课程学习
* [LG LGSVL|开源](https://github.com/lgsvl/simulator) ⭐ 2,457 | 🐛 628 | 🌐 C# | 📅 2023-04-04 - 帮助开发者集中测试无人驾驶算法，目前平台已经集成了Duckietown, Autoware软件和百度Apollo平台。
...
* [Comma.ai Openpilot|开源](https://github.com/commaai/openpilot) ⭐ 63,554 | 🐛 136 | 🌐 Python | 📅 2026-09-03  - 开源驱动代理。
* [Autoware|开源](https://github.com/CPFL/Autoware) ⭐ 12,039 | 🐛 69 | 🌐 Dockerfile | 📅 2026-09-02  - 用于城市自动驾驶的集成开源软件。

### 可视化工具

* [通用Cruise WorldView|开源](https://github.com/cruise-automation/webviz) ⭐ 2,336 | 🐛 134 | 🌐 JavaScript | 📅 2022-12-17 -开放可视化组件便于开发者进行无人驾驶数据可视化处理。
* [优步ATG AVS|开源](https://avs.auto/#/) - 其主要包括两个repo: [xviz](https://github.com/uber/xviz) ⭐ 1,075 | 🐛 171 | 🌐 JavaScript | 📅 2024-07-05处理数据
  和 [streetscape.gl](https://github.com/uber/streetscape.gl) ⭐ 994 | 🐛 114 | 🌐 JavaScript | 📅 2024-07-04进行场景渲染。

### 其他

* [GTA Robotics SDC Environment](https://github.com/OSSDC/self-driving-car-1) ⭐ 62 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2017-02-19  - 为Udacity无人驾驶车（SDC）挑战做好准备的开发环境。
...
* [NeuroJS](https://github.com/janhuenermann/neurojs) ⭐ 4,370 | 🐛 6 | 🌐 JavaScript | 📅 2023-10-10  - javascript深度学习和强化学习库。 一个样本自动驾驶汽车实施。
* [DeepTraffic](https://github.com/lexfridman/deeptraffic) ⭐ 1,792 | 🐛 9 | 🌐 JavaScript | 📅 2023-08-01 - 作为MIT深度学习课程的一部分, 作为认知深度强化学习小游戏。仅需通过浏览器设置参数就可以进行训练和评估。
* [TensorKart](https://github.com/kevinhughes27/TensorKart) ⭐ 1,575 | 🐛 13 | 🌐 Python | 📅 2026-08-03  - 使用TensorFlow搭建的自驾驾驶MarioKart。
