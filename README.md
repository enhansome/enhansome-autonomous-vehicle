...
精选无人驾驶资源列表，修改自[takeitallsource/awesome-autonomous-vehicles](https://github.com/takeitallsource/awesome-autonomous-vehicles) ⭐ 2,391 | 🐛 2 | 📅 2024-03-15 :fire:.
...
* [GitHub: Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,224 | 🐛 30 | 🌐 Python | 📅 2026-08-27 :star:38.8K - `机器学习`框架、库和软件的`精选列表`。 由Joseph Misiti.Joseph Misiti维护
...
* [GitHub: Awesome Robotics](https://github.com/Kiloreux/awesome-robotics) ⭐ 6,994 | 🐛 38 | 📅 2024-09-22 :star:1.19K - 由kiloreux维护的机器人技术的各种书籍，课程和其他资源的列表。

### 计算机视觉|Computer Vision

* [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,525 | 🐛 92 | 📅 2024-05-17 :star: 9.7K (4年前更新)- 计算机视觉资源精选清单
...
* `PSPNet`[tensorflow/models](https://github.com/tensorflow/models/tree/master/research/deeplab) ⭐ 77,659 | 🐛 1,272 | 🌐 Python | 📅 2026-08-28和[hszhao/PSPNet](https://github.com/hszhao/PSPNet) ⭐ 1,662 | 🐛 78 | 🌐 C++ | 📅 2022-04-15 - `SOTA in (Semantic Segmentation & Real-Time Semantic Segmentation)`，[more detail](https://paperswithcode.com/paper/pyramid-scene-parsing-network),`CVPR 2017`\
  研究机构 : 香港中文大学、商汤\
...
* [百度 Apollo|开源](https://github.com/ApolloAuto/apollo) ⭐ 26,813 | 🐛 1,046 | 🌐 C++ | 📅 2026-04-16 - 帮助汽车行业及自动驾驶领域的合作伙伴结合车辆和硬件系统，快速搭建一套属于自己的自动驾驶系统。
* [微软 Airsim|开源](https://github.com/Microsoft/AirSim) ⭐ 18,426 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - 作为人工智能研究的平台，以实验自动驾驶汽车的深度学习，计算机视觉和强化学习算法。
* [英特尔Carla|开源](https://github.com/carla-simulator/carla) ⭐ 14,344 | 🐛 1,192 | 🌐 C++ | 📅 2026-08-31  - 用于城市自动驾驶系统的开发、训练和验证的开源模拟器，支持多种传感模式和环境条件的灵活配置
...
* [Comma.ai Openpilot|开源](https://github.com/commaai/openpilot) ⭐ 63,540 | 🐛 135 | 🌐 Python | 📅 2026-08-31  - 开源驱动代理。
* [Autoware|开源](https://github.com/CPFL/Autoware) ⭐ 12,034 | 🐛 72 | 🌐 Dockerfile | 📅 2026-08-24  - 用于城市自动驾驶的集成开源软件。
